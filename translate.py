...
def translate_article(lang: str):
    ...
    def _fn(state: State) -> dict:
        ...
        translate_prompt = f"""
Translate the following summary SENTENCE-BY-SENTENCE into {lang} and return ONLY the translated summary. The translated summary should be coherent and grammatically correct.
